    ...
    <div className="border-b border-gray-200 pb-8">
      ...
      <div className="space-y-8">
        {questions.map((question) => (
          <div key={question.id} className={`bg-gray-50 p-6 rounded-xl ${showAnswers ? (question.correctAnswer ? "border-l-4 border-green-500" : "border-l-4 border-red-500") : ""}`}>
              ...
              <div className="space-y-3">
                {question.options.map((option, index) => (
                  <label key={index} className="flex items-start cursor-pointer group" htmlFor={`${question.id}_${index}`}>
                    ...
                    <div className="ml-3 text-gray-700 group-hover:text-gray-900">
                      {option}
            ...
            {question.type === "text" && (
              <div>
                <div className="relative">
                  <textarea
                    id={question.id}
                    className="w-full border border-gray-300 rounded-lg p-4 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 h-40 bg-white"
